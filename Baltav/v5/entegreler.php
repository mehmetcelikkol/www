...
<div class="main-content">
    <div class="topbar d-flex justify-content-between align-items-center">
        <h5 class="m-0 page-title">Entegre Firmalar Yönetimi</h5>
        <div class="btn-group">
            <button onclick="tabloKopyala('entegreTablosu')" class="btn btn-sm btn-outline-primary"><i class="fa-solid fa-copy"></i> Kopyala</button>
            <button onclick="tabloExcelIndir('entegreTablosu', 'Entegre_Firmalar')" class="btn btn-sm btn-outline-success"><i class="fa-solid fa-file-excel"></i> Excel</button>
            <button onclick="tabloPdfIndir('entegreTablosu', 'Entegre_Firmalar')" class="btn btn-sm btn-outline-danger"><i class="fa-solid fa-file-pdf"></i> PDF</button>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="silo-card glass p-4">
                <table class="table table-hover align-middle" id="entegreTablosu">
